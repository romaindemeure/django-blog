...
class MyUserManager(BaseUserManager):
    def create_user(self, email, first_name, password=None, last_name=None, description=None):
        """
    ...
    def create_superuser(self, email, first_name, password=None, last_name=None, description=None):
        """
